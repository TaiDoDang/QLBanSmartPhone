...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
        ...
        if (tk != null) {
            // Lấy thông tin nhân viên từ MaNV của tài khoản
            NhanVien nv = new QuanLyNhanVienBUS().getNhanVien(tk.getMaNV());

            // *** THÊM KIỂM TRA NULL CHO NV TẠI ĐÂY ***
            if (nv == null) {
                JOptionPane.showMessageDialog(this, "Lỗi hệ thống: Không tìm thấy thông tin nhân viên liên kết với tài khoản này. Vui lòng kiểm tra dữ liệu cơ sở dữ liệu hoặc liên hệ quản trị viên.");
                return; // Dừng xử lý vì không có đối tượng NhanVien hợp lệ
            }

            // check xem nhân viên của tài khoản này có bị khóa (Ẩn) hay không
            // Dòng này giờ an toàn hơn vì nv đã được kiểm tra null
    ...
    public static String saveFileName = "temp.txt";
