...
//    JTextField txMaHoaDon = new JTextField(5); //20
//    JTextField txNhanVien = new JTextField(17); //17
//    JTextField txNgayLap = new JTextField(8); //9
//    JTextField txGioLap = new JTextField(8); //9
//    JTextField txKhachHang = new JTextField(17); //17
//    JTextField txTongTien = new JTextField(10); //20
//    JTextField txKhuyenMai = new JTextField(20); //17
    JTextField txMaPhieuNhap = new JTextField(5);
    JTextField txNhanVien = new JTextField(17);
    JTextField txNhaCC = new JTextField(17);
    JTextField txNgayLap = new JTextField(8);
    JTextField txGioLap = new JTextField(8);
    JTextField txTongTien = new JTextField(10);
