...
public class QuanLyTaiKhoanDAO {
    ...
    public ArrayList<TaiKhoan> readDB() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "-- ERROR! Lỗi đọc dữ liệu bảng tài khoản (SQL)\n" + ex.getMessage());
            ...
            JOptionPane.showMessageDialog(null, "-- ERROR! Lỗi đọc dữ liệu bảng tài khoản (Runtime)\n" + ex.getMessage());
