        ...
        try {
            ...
            if (r != null) {
                while (r.next()) {
                    ...
                    String bdStr = r.getString("NgayBD");
                    String ktStr = r.getString("NgayKT");
                    LocalDate ngaybd = (bdStr == null || bdStr.isBlank()) ? null : LocalDate.parse(bdStr);
                    LocalDate ngaykt = (ktStr == null || ktStr.isBlank()) ? null : LocalDate.parse(ktStr);
